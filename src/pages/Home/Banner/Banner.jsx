...
const Banner = () => {
  return (
    <div>
      <section className="relative min-h-[800px] bg-cover bg-center items-center text-center" style={{ backgroundImage: `url('https://i.ibb.co/cLVs7qr/pexels-lucasandrade-12477952.jpg')` }}>
